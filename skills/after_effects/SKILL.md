---
name: ae-expressions
description: Adobe After Effects expression generation for property automation, motion graphics templates, and data-driven animation. Use when users request AE expressions, motion automation, or want to link properties across compositions.
license: MIT
---
